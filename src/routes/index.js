...
router.post("/auth/forgot-password", authCtrl.forgotPassword); // gửi OTP quên mật khẩu
router.post("/auth/reset-password", authCtrl.resetPassword); // xác nhận OTP và đặt lại mật khẩu
